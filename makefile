#############################################################################
# Makefile for building: loteria_gui
# Generated by qmake (3.1) (Qt 5.15.13)
# Project:  loteria_gui.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile loteria_gui.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = loteria_gui1.0.0
DISTDIR = /home/lilith/grafika/loteria/loteria_gui/.tmp/loteria_gui1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		loteria_gui.pro include/blueprint.hpp \
		include/board.hpp \
		include/runner.hpp src/blueprint.cpp \
		src/board.cpp \
		src/main.cpp \
		src/runner.cpp
QMAKE_TARGET  = loteria_gui
DESTDIR       = 
TARGET        = loteria_gui
...
Makefile: loteria_gui.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		loteria_gui.pro
	$(QMAKE) -o Makefile loteria_gui.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/blueprint.hpp include/board.hpp include/runner.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/blueprint.cpp src/board.cpp src/main.cpp src/runner.cpp $(DISTDIR)/
...
blueprint.o: src/blueprint.cpp include/blueprint.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o blueprint.o src/blueprint.cpp

board.o: src/board.cpp include/board.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o board.o src/board.cpp

main.o: src/main.cpp include/board.hpp \
		include/blueprint.hpp \
		include/runner.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o src/main.cpp

runner.o: src/runner.cpp include/runner.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o runner.o src/runner.cpp
